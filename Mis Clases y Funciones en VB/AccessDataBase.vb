...
Public Module AccessDatabase
    ...
    ''' <remarks></remarks>
    Public Sub CompactDataBase(source As String,
                               pwdSource As String,
                               destiny As String,
                               pwdDestiny As String,
        ...
        Try
            ...
            If (dbe Is Nothing) Then _
                Throw New Runtime.InteropServices.COMException("No se encuentra instalado el motor de bases de datos Microsoft ACE.")
            ...
            If (pwdSource <> String.Empty) Then
                ...
                '
                Dim isNotAccess2007 As Boolean =
                    ((version <> AccessDatabaseTypeEnum.dbVersion120) AndAlso
                     (version <> AccessDatabaseTypeEnum.dbVersion140) AndAlso
            ...
            If (Not IO.File.Exists(tempFile)) Then _
                Throw New Runtime.InteropServices.COMException("No se ha podido compactar la base de datos.")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function ExecuteMethod(app As Object,
                                   ty As System.Type,
